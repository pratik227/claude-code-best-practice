...
::: info
This is an agent skill -- preloaded into `weather-agent`, not invoked directly.
:::
...
The orchestration workflow produces the following output files:

### Weather Summary (`output.md`)
...
The SVG weather card (`weather.svg`) is a visual representation of the current temperature in Dubai.
...
::: tip How Direct Invocation Skills Work
