...
::: info Implemented
Two skills are implemented as part of the **Command > Agent > Skill** architecture pattern, demonstrating two distinct skill invocation patterns: **agent skills** (preloaded) and **skills** (invoked directly).
:::
