...
description: "A summary of setup tips shared by Boris Cherny, creator of Claude Code, on January 3, 2026."
---
...
::: tip
Running multiple Claude sessions simultaneously is one of the biggest productivity multipliers. Number your terminal tabs so you can quickly switch between them.
:::
...
::: info
Even though Opus is bigger and slower than Sonnet, the reduced need for steering and better tool use means it is almost always faster end-to-end.
:::
...
::: tip
This creates a virtuous cycle: every code review becomes an opportunity to improve Claude's knowledge base for the entire team.
:::
...
::: warning
Don't skip the planning step. A good plan is the difference between Claude 1-shotting the implementation and going back and forth with corrections.
:::
...
::: warning
Avoid `--dangerously-skip-permissions`. Use `/permissions` to pre-allow known-safe commands instead — it's safer and the configuration is shareable with your team.
:::
