...
description: "A comprehensive guide on how Anthropic uses skills internally, shared by Thariq on March 17, 2026."
---
...
::: info
Skills are not just markdown files — they are **folders** that can include scripts, assets, data, and more. The agent can discover, explore, and manipulate everything inside.
:::
...
::: tip
It can be worth having an engineer spend a week just making your verification skills excellent — they pay for themselves many times over.
:::
...
::: tip
The Gotchas section is the highest-signal content in any skill. Build it up from common failure points and keep updating it over time.
:::
...
::: warning
Instead of prescriptive step-by-step instructions, give Claude the goal and constraints. Let it adapt to the situation.
:::
...
::: info
The description field is not a human summary — it's a description of **when to trigger** this skill. Write it for the model, not for humans.
:::
