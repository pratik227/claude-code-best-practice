...
::: tip What's Next?
Once you are logged in, you are ready to start using Claude Code. Type `claude` in any project directory to begin an interactive session.
:::
